  ...
  return (
    <div className="w-4/5">
      <Head>
        ...
        <meta
          name="description"
          content="Create your own Solana SPL Token using our no code tool which is cheap and easy to use"
        />
      </Head>
      <div className="bg-foreground text-primary font-BeVietnamPro p-4 flex flex-col items-center rounded-lg text-sm sm:text-base break-words">
        <h1 className="mt-20 text-lg sm:text-4xl font-black">
          Solana Token Creation Guide
        </h1>
        <p className="w-2/3 sm:w-1/2 mt-4">
        ...
        <h1 className="text-base sm:text-xl mt-10 font-bold">
        ...
        <div className="w-2/3 sm:w-1/2">
          ...
          <p>
            4. Select the decimals quantity (0 for Whitelist Token, 5 for
          ...
          <p className="mt-4">
            The cost of Token creation is 0.1 SOL, covering all fees for SPL
            Token Creation.
          </p>
        </div>

        <h1 className="text-base sm:text-xl mt-10 p-2 font-bold ">
          Revoke Freeze Authority:
        </h1>
        <p className="w-2/3 sm:w-1/2">
        ...
        <p className="w-2/3 sm:w-1/2">
          ...
          minted than the total supply. This provides security and peace of mind
          to buyers. The cost is 0.1 SOL
        </p>
        ...
        <p className="w-2/3 sm:w-1/2">
          ...
          Once complete, you will receive the total supply of the token in your
          wallet.
        </p>
        ...
        <br />
        <p className="w-2/3 sm:w-1/2 mb-20">
