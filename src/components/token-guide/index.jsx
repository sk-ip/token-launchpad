export default function TokenCreationGuide() {
  return (
    <div className="bg-white p-4 flex flex-col items-center rounded-lg">
      <h1 className=" mt-10 text-4xl font-bold">Solana Token Creation Guide</h1>
      ...
      <br/>
      <p className="w-1/2 mb-20" >You can choose to revoke mint authority later if you choose</p>
    </div>
  );
}
